...
noble.on('discover', function(peripheral) {
  ...
  peripheral.on('servicesDiscover', function(services) {
    ...
    services[serviceIndex].on('includedServicesDiscover', 
...
isNotification);
      ...
      characteristics[characteristicIndex].on('broadcast', 
function(state) {
      ...
      characteristics[characteristicIndex].on('notify', function(state) 
{
      ...
      characteristics[characteristicIndex].on('descriptorsDiscover', 
